"use strict";
function perguntaEObriga(pergunta, resposta1, resposta2, resposta3) {
    let resposta;
    resposta = prompt(pergunta);
    while ((resposta === null || resposta === void 0 ? void 0 : resposta.toLocaleLowerCase()) != resposta1 && (resposta === null || resposta === void 0 ? void 0 : resposta.toLocaleLowerCase()) != resposta2 && (resposta === null || resposta === void 0 ? void 0 : resposta.toLocaleLowerCase()) != resposta3) {
...
while (jogarnovamente) {
    let respostaD1 = perguntaEObriga('Andando por uma floresta mágica em busca de sua capivara modificada você encontra uma pirâmide de onde vem um latido idêntico ao dela. Deseja entrar na pirâmide?\nOpções:\n1 - Sim\n2 - Encerrar o jogo', 'sim', 'encerrar o jogo', 'nao');
    if (respostaD1 === 'sim') {
        let respostaD2 = perguntaEObriga('Entrando na pirâmide você escuta o latido aumentar. Então você chama por sua capivara e escuta passos vindo em sua direção, mas ao lado da porta você avista um baú. Deseja abrir?\nOpções:\n1 - Sim\n2 - Não\n3 - Sair', 'sim', 'não', 'sair');
        if (respostaD2 === 'sim') {
            alert('Você abriu o baú e encontrou uma espada!');
            let respostaD3 = perguntaEObriga('Os passos aumentam e de repente... UM MONSTRO!! Deseja enfrentá-lo?\nOpções:\n1 - Enfrentar\n2 - Correr', 'enfrentar', 'correr', '');
            if (respostaD3 === 'enfrentar') {
                let nivelDePoderMonstro = Math.floor(Math.random() * 10) + 1; // Aleatório de 1 a 10
                let nivelDePoderEspada = Math.floor(Math.random() * 10) + 1; // Aleatório de 1 a 10
                ...
                if (nivelDePoderEspada <= nivelDePoderMonstro) {
                    ...
                    let respostaF1 = perguntaEObriga('O castelo começa a desmoronar, então você e sua capivara começam a correr para a porta principal. No caminho você encontra uma moto e um triciclo. Qual você deseja usar?\nOpções:\n1 - Moto\n2 - Triciclo\n3 - Correr', 'moto', 'triciclo', 'correr');
                    if (respostaF1 === 'moto') {
                ...
                let respostaD4 = perguntaEObriga('Você quer correr para onde?\nOpções:\n- Norte\n- Sul\n- Leste', 'norte', 'sul', 'leste');
                if (respostaD4 === 'sul') {
                    ...
                    let respostaD7 = perguntaEObriga('Você acha estranho os comportamentos dela ultimamente!! O que voçê faz?\nOpções:\n- investigar', 'investigar', ' ', ' ');
                    if (respostaD7 === 'investigar') {
                        alert('Você decide investigar a estranheza em torno da capivara.');
                        let respostaD8 = perguntaEObriga('Você encontra um baú, abrir?\nOpções:\n- sim\n- não', 'sim', 'não', ' ');
                        if (respostaD8 == 'sim') {
            ...
            let respostaD4 = perguntaEObriga('Os passos aumentam e de repente... UM MOSTRO!! Você está desarmado, o que deseja fazer?\nOpções:\n1 - Esconder\n2 - Disfarçar\n3 - Esperar', 'esconder', 'disfarçar', 'esperar');
            let i = 0;
            ...
            if (respostaD4 === 'esconder') {
                ...
                let respostaF2 = perguntaEObriga('Você leva sua capivara até a saída, mas encontra o monstro dormindo. O que fazer?\nOpções:\n1 - Silêncio\n2 - Correr\n3 - Aviso', 'silêncio', 'correr', 'aviso');
        ...
        if ((respostaD6 === null || respostaD6 === void 0 ? void 0 : respostaD6.toLocaleLowerCase()) == 'sim') {
            jogarnovamente = true;
        }
